...
{  
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_AFIO, ENABLE); //EXTI사용을 위해서
        RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1, ENABLE); // USART 1 동기화
        RCC_APB2PeriphClockCmd(RCC_APB1Periph_USART2, ENABLE); // USART 2 동기화
...
void GPIO_Configure(void)
{
    ...
    /* USART1 pin setting */
    //USART 1 TX 는 Pin9를 이용해서 입력을 받는다.
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9; 
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    //USART 1 RX 는 Pin10을 이용해서 입력을 받는다.
